...
\begin{table}
\caption{Design of N-tuple networks and Vertical Split Encoding for 2048. The numbers in parentheses after value ranges show the number of possible values after the corresponding mapping.}
\label{fig:NTupleVSE}
\centering\includegraphics[width=.99\linewidth]{figures/NT-table.pdf}
\end{table}
