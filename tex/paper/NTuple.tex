...
\begin{table}
\caption{Design of N-tuple networks and Vertical Split Encoding for 2048. The number in parentheses after each value range shows the number of possible values after corresponding mapping.}
\label{fig:NTupleVSE}
